...
class token:
	...
	def setRestricted(self):
		...
		chat.sendMessage(glob.BOT_NAME, self.username, "Your account is currently in restricted mode. Please visit (Akatsuki's website)[https://osu.akatsuki.pw] for more information.")
